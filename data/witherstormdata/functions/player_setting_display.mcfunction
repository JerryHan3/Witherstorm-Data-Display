...
tellraw @s ""
tellraw @s {"text": "=全域设置（仅OP可操作）=", "color": "light_purple", "bold": true}
tellraw @s [{"text": "显示侧边栏  ", "color": "white"}, {"text":"【开】", "color": "green", "bold": true, "clickEvent": {"action": "run_command", "value": "/scoreboard objectives setdisplay sidebar witherStormData"}}, {"text":"【关】", "color": "red", "bold": true, "clickEvent": {"action": "run_command", "value": "/scoreboard objectives setdisplay sidebar"}}]
tellraw @s ""
